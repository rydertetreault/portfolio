  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <p
          className={`text-emerald-400/90 text-lg sm:text-xl font-medium tracking-wide mb-6 transition-all duration-700 ease-out ${
            mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
        ...
        <p
          className={`text-neutral-400 text-base sm:text-lg max-w-xl mx-auto mb-10 leading-relaxed transition-all duration-700 ease-out ${
            mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
          }`}
